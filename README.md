...
- `prefix + C-m + a` - toggle monitor-activity
- `prefix + C-m + b` - toggle monitor-bell
- `prefix + C-m + s` - toggle monitor-silence (between off and N seconds)
- `prefix + C-m + t` - toggle both monitor-activity and monitor-silence (to switch back and forth between the two)
